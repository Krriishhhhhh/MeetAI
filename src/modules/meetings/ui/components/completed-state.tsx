    ...
    return (
        <div className="flex flex-col gap-y-4">
            <Tabs defaultValue="summary">
                ...
                {/* This is the options in the tab */}
                <div className="bg-white rounded-lg border px-3 ">
                    <ScrollArea>
                        <TabsList className="p-0 bg-background justify-start rounded-none h-13">

                            {/* This is where summary will be shown */}
                            <TabsTrigger
                            ...
                            {/* This is where Transcript will be shown */}
                            <TabsTrigger
                                className="text-muted-foreground rounded-none bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
                                value="transcript">
                                <FileTextIcon />
                            ...
                            {/* This is where recording will be shown */}
                            <TabsTrigger
                                className="text-muted-foreground rounded-none bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
                                value="recording">
                                <FileVideoIcon />
                            ...
                            {/* This is where we can ask AI something */}
                            <TabsTrigger
                                className="text-muted-foreground rounded-none bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
                                value="chat">
                                <SparklesIcon />
                            ...
                            <div>
                                <Markdown
                                    components={{
                                        ...
                                        strong: (props) => (
                                            <strong className="font-smeibold" {...props} />
                                        ),
                                        code: (props) => (
